...
class Info(commands.Cog):
    ...
    async def downloads(self, ctx):
        ...
        str.append("**Pre-setup UT (from rX of the TDM community)**: <https://docs.google.com/document/d/1BOl6Dq4vvS8n6C-FNSLjGfdocCqvWXcgNjiLgFkH-KQ/edit?usp=sharing>")
        str.append("")
        str.append("**__Useful Extras__**")
        str.append("**LeagueAS140** available here: <https://www.utassault.net/leagueas/?downloads>")
        str.append("**UTA Maps (download Maps/Textures/Sounds/Music folders and add to your UT install)**: <https://github.com/Sizzl/UTA-PugServer/tree/master/ut-server>")        
        str.append("**AssaultBonusPak.u**(*required for playing some maps, included in UTA Map Pack*): <https://github.com/Sizzl/UTA-PugServer/blob/master/ut-server/System/AssaultBonusPack.u>")
